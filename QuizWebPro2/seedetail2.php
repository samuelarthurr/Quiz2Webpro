...
if (isset($_POST['id'])) {
  ...
  $content = $row['Content'];
     ...
     echo '<div class="diary_Container2 diary_Round">
        ...
        <div class="button buttonRound"><a href="public.php" style="text-decoration: none; color: white; font-weight: bold; font-family: system-ui, -apple-system, BlinkMacSystemFont, Roboto, Oxygen, Ubuntu, Cantarell, sans-serif;">BACK</a></div>
      </div>';
}
	  ?>
